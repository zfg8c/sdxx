...
for epoch in range(epochs):
    ...
    print(f'Epoch {epoch} finished, model saved to {model_filename}')

# Epoch 0 finished, average loss 0.44732987404027036, hits@20 0.39471024258760107

# 加载模型权重
model_path = 'model_epoch_4.h5'  # 假设这是您最后一次保存的模型文件
